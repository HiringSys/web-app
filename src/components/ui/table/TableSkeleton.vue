...
const gridTemplateColumns = computed(() =>
  gridTemplate(visibleColumns.value, [], props.draggable),
);
</script>
...
<template>
  <div class="overflow-x-auto scrollbar-hide">
    <div class="flex min-w-fit flex-col gap-3">
      <div
        class="grid items-center gap-4 rounded-medium bg-white px-4 py-3"
      ...
      <div class="flex flex-col gap-2">
        <div
          v-for="n in rows"
          :key="n"
          class="flex items-center rounded-medium bg-white px-4 py-3"
        >
          <div

...
<template>
  <div
    class="relative flex flex-row justify-between rounded-medium px-4 py-3 select-none overflow-hidden"
    :class="blocked ? 'bg-black/5' : 'bg-white'"
  >
    ...
    <div
      class="absolute px-4 h-full right-0 top-1/2 -translate-y-1/2 flex flex-row items-center-safe gap-2"
      :class="blocked ? 'bg-black/5' : 'bg-white'"
    >
